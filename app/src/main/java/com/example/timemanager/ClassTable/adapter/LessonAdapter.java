package com.example.timemanager.ClassTable.adapter;
...
public class LessonAdapter extends BaseAdapter {
    ...
    public LessonAdapter(Context context, @NonNull List<Class_Table_Course> courseList, View.OnClickListener listener){
