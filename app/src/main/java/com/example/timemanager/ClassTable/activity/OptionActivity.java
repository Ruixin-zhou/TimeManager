...
public class OptionActivity extends AppCompatActivity {
    ...
    private List<Class_Table_Course> classTableCourseList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvContent.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Class_Table_Course classTableCourse = classTableCourseList.get(position);
                Intent intent = new Intent(OptionActivity.this, UpdateCourseActivity.class);
                intent.putExtra("classTableCourse", classTableCourse);
     ...
     */
    private void show() {
        classTableCourseList = courseDao.listAll();
        int listSize = classTableCourseList.size();
        if (listSize > 0) {
            String[] courseNames = new String[listSize];
            for (int i = 0; i < listSize; i++) courseNames[i] = classTableCourseList.get(i).getCourseName();
                ...
                .setPositiveButton("添加", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if ("".equals(courseName) || "".equals(startWeek) || "".equals(endWeek)) {
                            ...
                            classTableCourse.setCourseName(courseName);
